...
uint16  dot_matrix_screen_brightness = 3000;       // 屏幕亮度
...
const uint8 tld7002_ascii_font_5x7[][7] =
{
    ...
    { 0x08, 0x1C, 0x2A, 0x08, 0x08, 0x08, 0x08},  // #  3  上
    { 0x08, 0x08, 0x08, 0x08, 0x2A, 0x1C, 0x08},  // $  4  下
    { 0x00, 0x00, 0x10, 0x3E, 0x10, 0x00, 0x00},  // %  5  左
    { 0x00, 0x00, 0x04, 0x3E, 0x04, 0x00, 0x00},  // &  6  右
